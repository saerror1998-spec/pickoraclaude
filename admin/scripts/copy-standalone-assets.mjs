...
// Skipping this step is what was causing production requests (like the
// admin product-edit save) to fail after a build: the standalone server
// started, but couldn't serve its own static chunks or /public assets.
