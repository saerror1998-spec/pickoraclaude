...
export function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <div className="group relative">
      ...
      <div className="rounded-[var(--radius-card)] border border-black/5 bg-white p-5 shadow-[var(--shadow-soft)] transition-transform duration-[250ms] ease-[var(--ease-expo-out)] hover:-translate-y-1 hover:scale-[1.02]">
        <Link
          href={`/products/${product.slug}`}
          className="block focus-visible:-translate-y-1"
