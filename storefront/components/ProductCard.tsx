  ...
  return (
    <div className="group relative">
      ...
      <Link
        ...
        className="block rounded-[var(--radius-card)] bg-white p-5 shadow-[var(--shadow-soft)] transition-transform duration-[250ms] ease-[var(--ease-expo-out)] hover:-translate-y-1 hover:scale-[1.02] focus-visible:-translate-y-1"
