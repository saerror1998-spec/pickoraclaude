...
export const BRAND_META: Record<string, { title: string; description: string; intro: string }> = {
  Dell: {
...
export function brandMeta(brandName: string): { title: string; description: string; intro: string } {
